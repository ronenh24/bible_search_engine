...
class ColbertRanker:
    ...
    def __init__(self, colbert_model_name: str,
        ...
        """
        url = "https://4d82f897-e302-46c1-a021-b48462d3f2ec.us-west-2-0.aws" +\
            ".cloud.qdrant.io:6333"
        api_key = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhY2Nlc3MiOiJtIn0" +\
            ".8IVWJHJ8FL20GYSTmMkeI5GAyUc0PibP8cigIx_6xYw"
